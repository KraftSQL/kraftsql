...
class SubexpressionCollectorTest {
    ...
    @Test
    fun `GenericSubexpressionCollector can collect left and right of NotEquals`() {
        val notEquals = NotEquals(mock<Expression<DummyEngine, Any?>>(), mock<Expression<DummyEngine, Any?>>())
    ...
    @Test
    fun `GenericSubexpressionCollector can collect expression of GreaterThan`() {
        val greaterThan = GreaterThan(mock<Expression<DummyEngine, *>>(), mock<Expression<DummyEngine, *>>())
    ...
    fun `GenericSubexpressionCollector can collect expression of Sum`() {
        val sum = Sum.Companion(mock<Expression<DummyEngine, Int>>())
